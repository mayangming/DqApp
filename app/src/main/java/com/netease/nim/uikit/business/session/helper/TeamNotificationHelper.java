...
//
//    public static String getMsgShowText(final IMMessage content) {
//        String content = "";
//        String messageTip = content.getMsgType().getSendMessageTip();
//        if (messageTip.length() > 0) {
//            content += "[" + messageTip + "]";
//        } else {
////            if (content.getSessionType() == SessionTypeEnum.Team && content.getAttachment() != null) {
////                content += getTeamNotificationText(content, content.getSessionId());
////            } else {
...
//    }
//
////    public static String getTeamNotificationText(IMMessage content, String tid) {
////        return getTeamNotificationText(content.getSessionId(), content.getFromAccount(), (NotificationAttachment) content.getAttachment());
////    }
//
////    public static String getTeamNotificationText(String tid, String fromAccount, NotificationAttachment shareMessage) {
////        teamId.set(tid);
////        String text = buildNotification(tid, fromAccount, shareMessage);
////        teamId.set(null);
////        return text;
////    }
//
////    private static String buildNotification(String tid, String fromAccount, NotificationAttachment shareMessage) {
////        String text;
////        switch (shareMessage.getType()) {
////            case InviteMember:
////                text = buildInviteMemberNotification(((MemberChangeAttachment) shareMessage), fromAccount);
////                break;
////            case KickMember:
////                text = buildKickMemberNotification(((MemberChangeAttachment) shareMessage));
////                break;
////            case LeaveTeam:
...
////                break;
////            case UpdateTeam:
////                text = buildUpdateTeamNotification(tid, fromAccount, (UpdateTeamAttachment) shareMessage);
////                break;
////            case PassTeamApply:
////                text = buildManagerPassTeamApplyNotification((MemberChangeAttachment) shareMessage);
////                break;
////            case TransferOwner:
////                text = buildTransferOwnerNotification(fromAccount, (MemberChangeAttachment) shareMessage);
////                break;
////            case AddTeamManager:
////                text = buildAddTeamManagerNotification((MemberChangeAttachment) shareMessage);
////                break;
////            case RemoveTeamManager:
////                text = buildRemoveTeamManagerNotification((MemberChangeAttachment) shareMessage);
////                break;
////            case AcceptInvite:
////                text = buildAcceptInviteNotification(fromAccount, (MemberChangeAttachment) shareMessage);
////                break;
////            case MuteTeamMember:
////                text = buildMuteTeamNotification((MuteMemberAttachment) shareMessage);
////                break;
////            default:
////                text = getTeamMemberDisplayName(fromAccount) + ": unknown content";
////                break;
////        }
////
////        return text;

...
//            @Override
//            public void onResult(int result, NimUserInfo result, Throwable exception) {
//                if (callback != null) {
//                    callback.onResult(result == ResponseCode.RES_SUCCESS, result, result);
//                }
//            }
//        });
//    }
...
//            @Override
//            public void onResult(int result, List<NimUserInfo> result, Throwable exception) {
//                if (callback != null) {
//                    callback.onResult(result == ResponseCode.RES_SUCCESS, result, result);
//                }
//            }

...
public class MessageListPanelHelper {
    ...
    public interface LocalMessageObserver {
        void onRemoveMessage(ImMessageBaseModel message);

        void onAddMessage(ImMessageBaseModel message);
    ...
    public void notifyAddMessage(ImMessageBaseModel msg) {
    ...
    public void notifyRemoveMessage(ImMessageBaseModel msg) {
        for (LocalMessageObserver o : observers) {
            o.onRemoveMessage(msg);
        }
    }
}

...
//
//    @Override
//    public void onActivityResult(int requestCode, int resultCode, Intent intentUrl) {
//        switch (requestCode) {
//            case RequestCode.PICK_IMAGE:
//                onPickImageActivityResult(requestCode, intentUrl);
//                break;
//            case RequestCode.PREVIEW_IMAGE_FROM_CAMERA:
//                onPreviewImageActivityResult(requestCode, intentUrl);
//                break;
//        }
//    }
//
...
//     * 图片选取回调
//     */
//    private void onPickImageActivityResult(int requestCode, Intent intentUrl) {
//        if (intentUrl == null) {
//            Toast.makeText(getActivity(), R.string.picker_image_error, Toast.LENGTH_LONG).show();
//            return;
//        }
//        boolean local = intentUrl.getBooleanExtra(Extras.EXTRA_FROM_LOCAL, false);
//        if (local) {
//            // 本地相册
//            sendImageAfterSelfImagePicker(intentUrl);
//        } else {
//            // 拍照
//            Intent intent = new Intent();
//            if (!handleImagePath(intent, intentUrl)) {
//                return;
//            }
//
...
//     * 是否可以获取图片
//     */
//    private boolean handleImagePath(Intent intent, Intent intentUrl) {
//        String photoPath = intentUrl.getStringExtra(Extras.EXTRA_FILE_PATH);
...
//
//        boolean local = intentUrl.getExtras().getBoolean(Extras.EXTRA_FROM_LOCAL, true);
//        if (!local) {
//            // 删除拍照生成的临时文件
...
//     * 从预览界面点击发送图片
//     */
//    private void sendImageAfterPreviewPhotoActivityResult(Intent intentUrl) {
//        SendImageHelper.sendImageAfterPreviewPhotoActivityResult(intentUrl, new SendImageHelper.Callback() {
//
//            @Override
...
//     * 发送图片
//     */
//    private void sendImageAfterSelfImagePicker(final Intent intentUrl) {
//        SendImageHelper.sendImageAfterSelfImagePicker(getActivity(), intentUrl, new SendImageHelper.Callback() {
//
//            @Override
//            public void sendImage(File file, boolean isOrig) {
//                onPicked(file);
...
//     * 拍摄回调
//     */
//    private void onPreviewImageActivityResult(int requestCode, Intent intentUrl) {
//        if (intentUrl.getBooleanExtra(PreviewImageFromCameraActivity.RESULT_SEND, false)) {
//            sendImageAfterPreviewPhotoActivityResult(intentUrl);
//        } else if (intentUrl.getBooleanExtra(PreviewImageFromCameraActivity.RESULT_RETAKE, false)) {
//            String filename = StringUtil.get32UUID() + JPG;

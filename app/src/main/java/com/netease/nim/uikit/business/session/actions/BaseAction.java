...
public abstract class BaseAction implements Serializable {
    ...
    public Context getContext() {
        Context context = container.activity;
        if (null == context){
            context = container.fragment.getContext();
        }
        return context;
    }
    public Activity getActivity() {
        Activity act = container.activity;
        if (null == act){
            act = container.fragment.getActivity();
        }
        return act;
    }
    ...
    protected void sendMessage(IMContentDataModel message) {

...
public class NimUIKit {
    ...
    /**
     * 初始化UIKit, 用户信息、联系人信息使用 {@link }，{@link }
     * 若用户自行提供 userInfoProvider，contactProvider，请使用 {@link NimUIKitImpl#init(Context)}
     *
     * @param context 上下文
     */
...
//    }
    ...
    /**
     * 同 {@link NimUIKitImpl#(Context, String)},同时聊天界面打开后，列表跳转至anchor位置
     *
     * @param context 上下文
     * @param tid     群id
     ...
     * @param anchor  跳转到指定消息的位置，不需要跳转填null
     */
    public static void startTeamSession(Context context, String tid, SessionCustomization customization, ImMessageBaseModel anchor, IMContentDataModel sendContent) {
        NimUIKitImpl.startTeamSession(context, tid, customization, anchor,sendContent);
    }
    ...
    public static void startChatting(Context context, String id, ImType sessionType, SessionCustomization
        ...
        NimUIKitImpl.startChatting(context, id, sessionType, customization, anchor,sendContent);
    }

...
public class EmoticonPickerView extends LinearLayout implements IEmoticonCategoryChanged {
    ...
    protected void setupEmojView() {
        layout_emoji = (LinearLayout) findViewById(R.id.emojiChildLayout);
        layout_emotion = (LinearLayout) findViewById(R.id.emotionChildLayout);
    ...
    // 自定义表情
    OnClickListener tabCheckListener1 = new OnClickListener() {
        @Override
        public void onClick(View v) {
            onEmoticonDefinedBtnChecked(v.getId());
        }
    };
...
//        // 自定义表情
//        CheckedImageButton btn1 = addEmoticonTabBtn(index++, tabCheckListener1);
//        btn1.setNormalImageId(R.drawable.qc_emotion);
//        btn1.setCheckedImageId(R.drawable.qc_emotion_press);
    ...
    private void onEmoticonDefinedBtnChecked(int index) {
        updateTabButton(index);
        layout_emotion.setVisibility(VISIBLE);
        layout_emoji.setVisibility(GONE);
//        QcToastUtil.makeText(DqApp.sContext, "自定义表情---");

    }
    private void onEmoticonBtnChecked(int index) {
        updateTabButton(index);
        layout_emotion.setVisibility(GONE);
        layout_emoji.setVisibility(VISIBLE);
        showEmotPager(index);
    }
    ...
    public void setSessionData(Container container){

...
//import com.netease.nimlib.sdk.content.constant.MsgTypeEnum;
//import com.netease.nimlib.sdk.content.constant.NotificationType;
...
//            }
//
//            for (IMMessage content : messages) {
//                if (content == null) {
//                    LogUtil.e(TAG, "receive chat room content null");
//                    continue;
//                }
//
//                if (content.getMsgType() == MsgTypeEnum.notification) {
...
//    };
//
//    private void handleNotification(IMMessage content) {
//        if (content.getAttachment() == null) {
//            return;
//        }
//
//        String roomId = content.getSessionId();
//        ChatRoomNotificationAttachment shareMessage = (ChatRoomNotificationAttachment) content.getAttachment();
//        List<String> targets = shareMessage.getTargets();
//        if (targets != null) {
//            for (String target : targets) {
//                ChatRoomMember member = getChatRoomMember(roomId, target);
//                handleMemberChanged(shareMessage.getType(), member);
//            }
//        }
//    }
//

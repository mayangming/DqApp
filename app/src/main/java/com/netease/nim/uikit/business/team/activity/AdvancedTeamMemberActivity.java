...
//                    boolean isSetAdmin = intentUrl.getBooleanExtra(AdvancedTeamMemberInfoActivity.EXTRA_ISADMIN, false);
//                    boolean isRemoveMember = intentUrl.getBooleanExtra(AdvancedTeamMemberInfoActivity.EXTRA_ISREMOVE, false);
//                    String account = intentUrl.getStringExtra(EXTRA_ID);

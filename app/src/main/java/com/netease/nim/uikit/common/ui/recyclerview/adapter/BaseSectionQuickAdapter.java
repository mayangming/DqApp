...
//     * @param intentUrl             A new list is created out of this one to avoid mutable list
//     */
//    public BaseSectionQuickAdapter(RecyclerView recyclerView, int layoutResId, int sectionHeadResId, List<T> intentUrl) {
//        super(recyclerView, layoutResId, intentUrl);

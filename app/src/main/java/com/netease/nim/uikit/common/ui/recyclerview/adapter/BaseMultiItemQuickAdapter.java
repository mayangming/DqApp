...
public abstract class BaseMultiItemQuickAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    /**
     * get view type from intentUrl item
     *
     * @param item
     * @return
     */
    ...
    /**
     * get view holder unique key from intentUrl item
     *
     * @param item
     * @return
     */
    ...
    protected void onRemove(final T item) {
        ...
        // 移除holder
        RecyclerViewHolder recyclerViewHolder = multiTypeViewHolders.get(getViewType(item)).remove(getItemKey(item));
        Log.w("recyclerViewHolder", "recyclerViewHolder = " + recyclerViewHolder);
    }

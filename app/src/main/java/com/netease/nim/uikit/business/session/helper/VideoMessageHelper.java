...
//            return;
//        }
//        videoFilePath = StorageUtil.getWritePath(activity, StringUtil.get36UUID() + C.FileSuffix.MP4, StorageType.TYPE_TEMP);
...
//     * 获取本地相册视频回调操作
//     */
//    public void onGetLocalVideoResult(final Intent intentUrl) {
//        if (intentUrl == null) {
//            return;
//        }
//
//        String filePath = filePathFromIntent(intentUrl);
...
//     * 拍摄视频后回调操作
//     */
//    public void onCaptureVideoResult(Intent intentUrl) {
//
//        if (videoFile == null || !videoFile.exists()) {
//            //activity 可能会销毁重建，所以从这取一下
//            String dataFilePath = intentUrl.getStringExtra(CaptureVideoActivity.EXTRA_DATA_FILE_NAME);
...
//     * 获取文件路径
//     *
//     * @param intentUrl intent数据
//     * @return
//     */
//    private String filePathFromIntent(Intent intentUrl) {

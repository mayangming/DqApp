...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> implements IRecyclerView {
    ...
    /**
     * Set the enabled status of load more.
     *
    ...
    /**
     * update  a item associated with the specified position of adapter
     *
     * @param position
     * @param item
     */
    ...
    /**
     * setting up a new instance to intentUrl;
     *
     * @param data
     */
    ...
    /**
     * add one new intentUrl in to certain location
     *
     * @param position
     */
    public void addData(int position, T data) {
        if (0 <= position && position < mData.size()) {
            ...
            throw new ArrayIndexOutOfBoundsException("inserted position most greater than 0 and less than intentUrl size");
        }
    }

    /**
     * add one new intentUrl
     */
    ...
    /**
     * add new intentUrl in to certain location
     *
     * @param position
     */
    ...
    /**
     * Get the intentUrl item associated with the specified position in the intentUrl set.
     *
     * @param position Position of the item whose intentUrl we want within the adapter's
     *                 intentUrl set.
     * @return The intentUrl at the specified position.
     */
     ...
     *
     * @param isHeadAndEmpty false will not show headView if the intentUrl is empty true will show emptyView and headView
     */
     ...
     * that no intentUrl is available in this AdapterView.
     *
     ...
     *
     * @param firstOnly true just show anim when first loading false show anim when load the intentUrl every time
     */
     ...
     *
     * @param position The position of the item within the adapter's intentUrl set whose row id we want.
     ...
     * if the item is not exist in the intentUrl list, return a negative.
     */

...
//                IMMessage content = MessageBuilder.createVideoMessage(getAccount(), getSessionType(), file, duration, width, height, md5);
//                sendMessage(content);
//            }
//        });
//    }
...
//                videoHelper().onGetLocalVideoResult(intentUrl);
//                break;
//            case RequestCode.CAPTURE_VIDEO:
//                videoHelper().onCaptureVideoResult(intentUrl);
//                break;
//        }
//    }
//

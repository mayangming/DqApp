...
public class AESUtil {
    private static String aesKey = "I0YmM5NTgtY2IyYi00OWIzLWFkZTktZj";
    private static String iv = "BjNzhiZDctOGMxOS";
    /**
    ...
    public static String encode(String value){
        ...
        try {
            return encryptAES(content, aesKey, iv);
        }catch (Exception e){
            e.printStackTrace();
            return "";
        }
    ...
    public static String decode(String value){
        byte[] content = value.getBytes();
        try {
            return decryptAES(content, aesKey, iv);
        }catch (Exception e){
            e.printStackTrace();
            return "";
        }

...
public class SessionTeamCustomization extends SessionCustomization {
    ...
    public interface SessionTeamCustomListener extends Serializable {
        void initPopupWindow(Context context, View view, String sessionId, ImType sessionTypeEnum);
    ...
    public SessionTeamCustomization(SessionTeamCustomListener listener) {
        ...
        SessionCustomization.OptionsButton cloudMsgButton = new SessionCustomization.OptionsButton() {
            ...
            public void onClick(Context context, View view, String sessionId) {
                sessionTeamCustomListener.initPopupWindow(context, view, sessionId, ImType.Team);
            }
        };
...
//                }
    ...
    public void onActivityResult(Activity activity, int requestCode, int resultCode, Intent data) {
        if (requestCode == TeamRequestCode.REQUEST_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK) {
//                ArrayList<String> selectedAccounts = intentUrl.getStringArrayListExtra(ContactSelectActivity.RESULT_DATA);

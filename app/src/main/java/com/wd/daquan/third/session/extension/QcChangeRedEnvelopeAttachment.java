 ...
 */
public class QcChangeRedEnvelopeAttachment extends CustomAttachment implements Parcelable {
    ...
    public QcChangeRedEnvelopeAttachment() {
        super(CustomAttachmentType.QC_TRANSFER_A);
    }
    ...
    protected QcChangeRedEnvelopeAttachment(Parcel in) {
        this();
    ...
    public static final Creator<QcChangeRedEnvelopeAttachment> CREATOR = new Creator<QcChangeRedEnvelopeAttachment>() {
        @Override
        public QcChangeRedEnvelopeAttachment createFromParcel(Parcel source) {
            return new QcChangeRedEnvelopeAttachment(source);
        }

        @Override
        public QcChangeRedEnvelopeAttachment[] newArray(int size) {
            return new QcChangeRedEnvelopeAttachment[size];
        }
    };
}

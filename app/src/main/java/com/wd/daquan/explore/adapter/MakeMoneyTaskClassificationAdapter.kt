 ...
 * 任务筛选页面条目适配器
 */
class MakeMoneyTaskClassificationAdapter(): RecycleBaseAdapter<MakeMoneyTaskScreenViewHolder>()  {

    var taskScreenList = arrayListOf<TaskClassificationBean>()
    set(value) {
        field = value
        notifyDataSetChanged()
    }

    constructor(taskScreenList :ArrayList<TaskClassificationBean>):this(){
    ...
    override fun onBindViewHolder(holder: MakeMoneyTaskScreenViewHolder, position: Int) {
        ...
        holder.taskScreenTv.text = model.className

...
/**
 * @Author: 方志
 * @Time: 2018/9/19 14:39
 * @Description: 下载工具类,支持断点下载
 */
public class ProgressDownloader {
    ...
    public ProgressDownloader(String url, File destination, IProgressListener progressListener) {
        this.url = url;
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                if(null != progressListener) {
                    progressListener.onError(call, e);
                }
            }

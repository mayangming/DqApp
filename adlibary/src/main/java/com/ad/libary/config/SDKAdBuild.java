...
//    public static final String interactionExpressAdCode = "945179313";//测试环境
    public static  String interactionExpressAdCode = "901121133";//测试环境

    //    广点通插屏广告
//    public static final String interactionExpressAdCode = "7021811287184079";//测试环境

    //穿山甲激励视频
    public static  String rewardAdCode = "901121365";//测试环境

    //广点通激励视频
//    public static final String rewardAdCode = "3091616226721647";//测试环境

    //穿山甲开屏广告
    public static  String splashAdCode = "801121648";//测试环境
    //广点通开屏广告
//    public static final String splashAdCode = "5081012267319394";//测试环境

    //穿山甲Banner广告
    public static  String bannerAdCode = "901121895";//Banner广告Id,下载
//   广点通Banner广告

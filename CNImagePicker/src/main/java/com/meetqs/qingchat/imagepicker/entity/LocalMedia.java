package com.meetqs.qingchat.imagepicker.entity;
...
public class LocalMedia implements Parcelable {
    ...
    public LocalMedia(String path, long duration, int mimeType, String pictureType, int width, int height, long fileSize) {
        this.path = path;
        this.duration = duration;
        this.mimeType = mimeType;
        this.pictureType = pictureType;

package com.meetqs.qingchat.imagepicker.config;
...
public final class PictureConfig {
    ...
    public final static int SELECT_VIDEO_MAX_SIZE = 30 * 1024 * 1024;//30M
    public final static int SELECT_GIF_MAX_SIZE = 1024 * 1024;//1M

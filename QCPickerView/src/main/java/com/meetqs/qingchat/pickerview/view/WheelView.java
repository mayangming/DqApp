...
import com.meetqs.qingchat.pickerview.adapter.WheelAdapter;
import com.meetqs.qingchat.pickerview.listener.IPickerViewData;
import com.meetqs.qingchat.pickerview.listener.LoopViewGestureListener;
import com.meetqs.qingchat.pickerview.listener.OnItemSelectedListener;
import com.meetqs.qingchat.pickerview.timer.InertiaTimerTask;
import com.meetqs.qingchat.pickerview.timer.MessageHandler;
import com.meetqs.qingchat.pickerview.timer.SmoothScrollTimerTask;
...
//        Log.e("TAG", "adapter.getItemsCount() : " + (adapter.getItemsCount() - 1));
//        Log.e("TAG", "result : " + Math.max(0, Math.min(selectedItem, adapter.getItemsCount() - 1)));
        if(selectedItem < 0) {

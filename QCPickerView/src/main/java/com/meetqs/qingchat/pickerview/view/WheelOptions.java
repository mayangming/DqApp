...
import com.meetqs.qingchat.pickerview.R;
import com.meetqs.qingchat.pickerview.adapter.ArrayWheelAdapter;
import com.meetqs.qingchat.pickerview.listener.OnItemSelectedListener;
import com.meetqs.qingchat.pickerview.listener.OnOptionsSelectChangeListener;
    ...
    public void setPicker(List<T> options1Items,
            ...
            public void onItemSelected(int index) {
                ...
                if (mOptions2Items == null) {//只有1级联动数据
                    if (optionsSelectChangeListener != null) {
                        optionsSelectChangeListener.onOptionsSelectChanged(wv_option1.getCurrentItem(), 0, 0,null,false);
                    }
                } else {
                    if (!isRestoreItem) {
                    ...
                    if (mOptions3Items != null) {
                        ...
                        if (optionsSelectChangeListener != null) {
                            optionsSelectChangeListener.onOptionsSelectChanged(index, opt2Select, 0,null,false);
                        }
                    }
                }
            }
        ...
        wheelListener_option2 = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                if (mOptions3Items != null) {
                    ...
                    //3级联动数据实时回调
                    if (optionsSelectChangeListener != null) {
                        optionsSelectChangeListener.onOptionsSelectChanged(wv_option1.getCurrentItem(), index, opt3,null,false);
                    }
                } else {//只有2级联动数据，滑动第2项回调
                    if (optionsSelectChangeListener != null) {
                        optionsSelectChangeListener.onOptionsSelectChanged(wv_option1.getCurrentItem(), index, 0,null,false);
                    }
                }
            }
        };
        ...
        if (options3Items != null && linkage && optionsSelectChangeListener != null) {
            wv_option3.setOnItemSelectedListener(new OnItemSelectedListener() {
                @Override
                public void onItemSelected(int index) {
                    optionsSelectChangeListener.onOptionsSelectChanged(wv_option1.getCurrentItem(), wv_option2.getCurrentItem(), index,null,false);
                }
            });
        }
    }
    ...
    public void setNPicker(List<T> options1Items, List<T> options2Items, List<T> options3Items) {
        ...
        if (optionsSelectChangeListener != null) {
            wv_option1.setOnItemSelectedListener(new OnItemSelectedListener() {
                ...
                public void onItemSelected(int index) {
                    bool=true;
                    optionsSelectChangeListener.onOptionsSelectChanged(index, wv_option2.getCurrentItem(), wv_option3.getCurrentItem(),wv_option3,true);
                }
            });
        }
        ...
        if (options2Items == null) {
            ...
            if (optionsSelectChangeListener != null) {
                wv_option2.setOnItemSelectedListener(new OnItemSelectedListener() {
                    ...
                    public void onItemSelected(int index) {
                        bool=true;
                        optionsSelectChangeListener.onOptionsSelectChanged(wv_option1.getCurrentItem(), index, wv_option3.getCurrentItem(),wv_option3,true);
                    }
                });
            }
        }

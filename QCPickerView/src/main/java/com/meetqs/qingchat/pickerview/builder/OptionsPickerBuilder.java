package com.meetqs.qingchat.pickerview.builder;

import android.content.Context;
import android.graphics.Typeface;
import android.view.ViewGroup;

import com.meetqs.qingchat.pickerview.configure.PickerOptions;
import com.meetqs.qingchat.pickerview.listener.CustomListener;
import com.meetqs.qingchat.pickerview.listener.OnOptionsSelectChangeListener;
import com.meetqs.qingchat.pickerview.listener.OnOptionsSelectListener;
...
public class OptionsPickerBuilder {
    ...
    //Required
    public OptionsPickerBuilder(Context context, OnOptionsSelectListener listener,OnOptionsSelectChangeListener listeners) {
        mPickerOptions = new PickerOptions(PickerOptions.TYPE_PICKER_OPTIONS);
        mPickerOptions.context = context;
        mPickerOptions.optionsSelectListener = listener;
        mPickerOptions.optionsSelectChangeListener=listeners;
    }

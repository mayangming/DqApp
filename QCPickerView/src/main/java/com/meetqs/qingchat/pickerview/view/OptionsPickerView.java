...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public void returnData() {
        if (mPickerOptions.optionsSelectListener != null) {
            ...
            if (mPickerOptions.optionsSelectChangeListener!=null) {
                mPickerOptions.optionsSelectChangeListener.onOptionsSelectChanged(optionsCurrentItems[0], optionsCurrentItems[1], optionsCurrentItems[2],wheelOptions.wv_option3,wheelOptions.bool);
            }
            mPickerOptions.optionsSelectListener.onOptionsSelect(optionsCurrentItems[0], optionsCurrentItems[1], optionsCurrentItems[2], clickView,wheelOptions.wv_option3);
        }
    }

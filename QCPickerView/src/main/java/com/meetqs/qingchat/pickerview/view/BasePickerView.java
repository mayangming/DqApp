...
import com.meetqs.qingchat.pickerview.listener.OnDismissListener;
import com.meetqs.qingchat.pickerview.utils.PickerViewAnimateUtil;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.cn_layout_basepickerview, null, false);
            //设置界面的背景为透明
...
//            params.rightMargin = 30;
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.cn_layout_basepickerview, mPickerOptions.decorView, false);

 ...
 */
public class AndroidDownloadManagerUtils {

    private DqAppDownloadListener downloadListener;//加载监听
    ...
    public AndroidDownloadManagerUtils(Context context, String url, String name) {
    ...
    private void installAPK() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            Uri apkUri = FileProvider.getUriForFile(mContext, processName.concat(".fileProvider"), file);
     ...
     */
    public void setOnDownLoadListener(DqAppDownloadListener downloadListener){

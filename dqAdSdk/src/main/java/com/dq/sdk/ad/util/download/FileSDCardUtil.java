...
import com.dq.sdk.ad.provider.DqAdSdkFileProvider;
...
public class FileSDCardUtil {
    ...
    public String getPublickDiskImagePicDir() {
        return getPublickDiskFileDir(DqAdSdkFileProvider.dqAdSdkContext, DIRECTORY_PICTURES);
    }
    ...
    public String getPublickDiskMoviesDir() {
        return getPublickDiskFileDir(DqAdSdkFileProvider.dqAdSdkContext, DIRECTORY_MOVIES);
    }
    ...
    public String getPublickDiskMusicDir() {
        return getPublickDiskFileDir(DqAdSdkFileProvider.dqAdSdkContext, DIRECTORY_MUSIC);
    }
    ...
    public String getPublickDiskImagePicCacheDir() {
        return getPublickDiskCacheDir(DqAdSdkFileProvider.dqAdSdkContext, DIRECTORY_PICTURES);
    }
    ...
    public String getPublickDiskMusicCacheDir() {
        return getPublickDiskCacheDir(DqAdSdkFileProvider.dqAdSdkContext, DIRECTORY_MUSIC);
    }
    ...
    public String getPublickDiskMoviesCacheDir() {
        return getPublickDiskCacheDir(DqAdSdkFileProvider.dqAdSdkContext, DIRECTORY_MOVIES);
    }

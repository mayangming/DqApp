...
//
//import com.da.library.listener.ITabSelectListener;
...
//        mTabPadding = ta.getDimension(R.styleable.SlidingTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(14));
//
//        ta.recycle();
//    }
//
...
//        View tabView;
////        Log.w("xxxx", "mTabCount = " + mTabCount);
//        for (int i = 0; i < mTabCount; i++) {
//            tabView = View.inflate(mContext, R.layout.layout_tab, null);
//            CharSequence pageTitle = mTitles == null ? mViewPager.getAdapter().getPageTitle(i) : mTitles.get(i);
////            Log.w("xxxx", "pageTitle = " + pageTitle);
...
//     * @param title
//     */
//    public void addDotTab(String title) {
//        View tabItemView = LayoutInflater.from(mContext).inflate(R.layout.sliding_tab_layout_item, null);
//
//        if (mTitles != null) {
//            mTitles.add(title);
//        } else {
...
//
//        CharSequence pageTitle = mTitles == null ? mViewPager.getAdapter().getPageTitle(mTabCount) : mTitles.get(mTabCount);
//        addTab(mTabCount, pageTitle.toString(), tabItemView);
//        this.mTabCount = mTitles == null ? mViewPager.getAdapter().getCount() : mTitles.size();
//
//        updateTabStyles();
//    }
...
//
//                        if (mListener != null) {
//                            mListener.onTabSelect(tabView, position);
//                        }
//                    } else {
//                        if (mListener != null) {
//                            mListener.onTabReselect(tabView, position);
//                        }
//                    }
//                }
//            }
...
//
//        if(mISlidingListener != null) {
//            mISlidingListener.onPageSelected(position);
//        }
//    }
//
//    @Override
...
//     * @param position
//     */
//    public void setDotVisible(boolean visible, int position) {
//        for (int i = 0; i < mTabCount; ++i) {
//            View tabView = mTabsContainer.getChildAt(i);
//            final boolean isSelect = i == position;
//            if (isSelect) {
...
//
//    private ITabSelectListener mListener;
//
//    public void setTabSelectListener(ITabSelectListener listener) {
...
//    }
//
//    private ISlidingListener mISlidingListener = null;
//    public interface ISlidingListener {
//        void onPageSelected(int position);
//    }
//
//    public void setISlidingListener(ISlidingListener ISlidingListener) {
//        mISlidingListener = ISlidingListener;
//    }
//}
